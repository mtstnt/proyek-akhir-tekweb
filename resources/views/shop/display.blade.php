...
<div class="container-fluid p-3 bg-dark text-white text-center">
	...
	<p class="lead">Check out our edit of men’s new-in clothing for your weekly drop of the freshest
...
<div class="container-fluid bg-dark">
	<div class="d-flex flex-wrap flex-row justify-content-center">
		<div class="col-12 col-lg-6 mx-auto">
			<select class="btn btn-outline-primary bg-secondary text-white dropdown-toggle" type="button"
		...
		<div class="row text-light">
			<div class="col-lg-6 col-12">
				<input type="range" min="0" max="5000000" class="slider" id="rangeMin" value="0">
				<h5>Min : <span id="priceValueMin">0</span></h5>
			</div>
			<div class="col-lg-6 col-12">
				<input type="range" min="0" max="5000000" class="slider" id="rangeMax" value="5000000">
...
<script>
	...
	[rangeMin, rangeMax].forEach( el => {
		el.addEventListener('change', ev => {
			const filterRangeMax = document.getElementById('rangeMax').value;
			const filterRangeMin = document.getElementById('rangeMin').value;

			items.forEach(el => {
				const price = getNumberFromCurrency(el.querySelector('.item-pricetag').innerText);
