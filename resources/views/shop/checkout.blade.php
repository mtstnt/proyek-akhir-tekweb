                ...
                <div class="col-sm-8">
                    ...
                    <form action="#">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="Enter your card number" name="email">
                        </div>
                        <div class="form-group">
                            <label for="pwd">PASSWORD:</label>
                            <input type="password" class="form-control" id="pwd" placeholder="Enter your password to verify" name="pswd">
                        </div>
